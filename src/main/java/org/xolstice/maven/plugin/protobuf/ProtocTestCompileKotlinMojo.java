...
/**
 * This mojo executes the {@code protoc} compiler for generating test Java and Kotlin sources
 ...
 */
@Mojo(
        name = "test-compile-kotlin",
        defaultPhase = LifecyclePhase.GENERATE_TEST_SOURCES,
        requiresDependencyResolution = ResolutionScope.TEST,
        threadSafe = true
)
public final class ProtocTestCompileKotlinMojo extends AbstractProtocTestCompileMojo {

    /**
     * This is the directory into which the {@code .kt} test sources will be created.
     */
    @Parameter(
            required = true,
            property = "kotlinTestOutputDirectory",
            defaultValue = "${project.build.directory}/generated-test-sources/protobuf/kotlin"
    )
    ...
    protected void addProtocBuilderParameters(final Protoc.Builder protocBuilder) {
        ...
        protocBuilder.setKotlinOutputDirectory(getOutputDirectory());
