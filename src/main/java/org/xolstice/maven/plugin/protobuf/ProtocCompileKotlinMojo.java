...
/**
 * This mojo executes the {@code protoc} compiler for generating main Kotlin sources
...
public final class ProtocCompileKotlinMojo extends AbstractProtocCompileMojo {

    /**
     * This is the directory into which the {@code .kt} will be created.
     */
    @Parameter(
            required = true,
            property = "kotlinOutputDirectory",
            defaultValue = "${project.build.directory}/generated-sources/protobuf/kotlin"
    )
